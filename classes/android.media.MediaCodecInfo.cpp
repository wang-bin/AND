...
JMI_DEFINE_CONST(android::util::Range,  MediaCodecInfo::AudioCapabilities::getBitrateRange, JMI_ARG0())
JMI_DEFINE_CONST(std::vector<android::util::Range>,  MediaCodecInfo::AudioCapabilities::getSupportedSampleRateRanges, JMI_ARG0())
JMI_DEFINE_CONST(std::vector<android::util::Range>,  MediaCodecInfo::AudioCapabilities::getInputChannelCountRanges, JMI_ARG0())
...
JMI_DEFINE_CONST(android::util::Range,  MediaCodecInfo::VideoCapabilities::getBitrateRange, JMI_ARG0())
JMI_DEFINE_CONST(android::util::Range,  MediaCodecInfo::VideoCapabilities::getSupportedFrameRates, JMI_ARG0())
JMI_DEFINE_CONST(android::util::Range,  MediaCodecInfo::VideoCapabilities::getSupportedFrameRatesFor, JMI_ARG2(int, int))
JMI_DEFINE_CONST(android::util::Range,  MediaCodecInfo::VideoCapabilities::getSupportedWidths, JMI_ARG0())
JMI_DEFINE_CONST(android::util::Range,  MediaCodecInfo::VideoCapabilities::getSupportedWidthsFor, JMI_ARG1(int))
JMI_DEFINE_CONST(android::util::Range,  MediaCodecInfo::VideoCapabilities::getSupportedHeights, JMI_ARG0())
JMI_DEFINE_CONST(android::util::Range,  MediaCodecInfo::VideoCapabilities::getSupportedHeightsFor, JMI_ARG1(int))
JMI_DEFINE_CONST(android::util::Range,  MediaCodecInfo::VideoCapabilities::getAchievableFrameRatesFor, JMI_ARG2(jint, jint))
JMI_DEFINE_CONST(jboolean,  MediaCodecInfo::EncoderCapabilities::isBitrateModeSupported, JMI_ARG1(jint))
JMI_DEFINE_CONST(android::util::Range,  MediaCodecInfo::EncoderCapabilities::getComplexityRange, JMI_ARG0())
JMI_DEFINE_CONST(android::util::Range,  MediaCodecInfo::EncoderCapabilities::getQualityRange, JMI_ARG0())
