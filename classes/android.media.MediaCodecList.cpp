...
JMI_DEFINE_CONST(std::string, MediaCodecList::findDecoderForFormat, JMI_ARG1(const MediaFormat&))
JMI_DEFINE_CONST(std::string, MediaCodecList::findEncoderForFormat, JMI_ARG1(const MediaFormat&))
